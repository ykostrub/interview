package ykostrub.cn.ua.enumset;
...
public class EnumSetExample {
  ...
  public static final void main(
      final String... argumgents) {
    System.out.println("Work Schedule:");

    for (final Weekday weekday : Weekday.THE_WHOLE_WEEK) {
      System.out.println(String.format("%d. On %s you "
          + (weekday.isWorkday() ? "have to work" : "can relax") + ".", weekday.ordinal() + 1,
          weekday));
    }
